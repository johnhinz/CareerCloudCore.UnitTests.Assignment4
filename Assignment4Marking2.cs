...
namespace CareerCloudCore.UnitTests.Assignment4
{
    ...
    [TestClass]
    public class Assignment4Marking2
    {
        ...
        private void ApplicantProfileForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._applicantSkills.Id, applicantProfilePoco.ApplicantSkills.FirstOrDefault().Id);
            ...
            Assert.AreEqual(this._appliantWorkHistory.Id, applicantProfilePoco.ApplicantWorkHistorys.FirstOrDefault().Id);
        }
        ...
        private void SecurityLoginRoleForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._securityLogin.Id, securityLoginsRolePoco.SecurityLogin.Id);

            Assert.IsNotNull(securityLoginsRolePoco.SecurityRole);
            Assert.AreEqual(this._securityRole.Id, securityLoginsRolePoco.SecurityRole.Id);
        ...
        private void SecurityLoginLogForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._securityLogin.Id, securityLoginsLogPoco.SecurityLogin.Id);
        }
        ...
        private void SecurityLoginForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._applicantProfile.Id, securityLoginPoco.ApplicantProfiles.FirstOrDefault().Id);

            Assert.IsNotNull(securityLoginPoco.SecurityLoginsLogs);
            Assert.IsTrue(securityLoginPoco.SecurityLoginsLogs.Count > 0);
            Assert.AreEqual(this._securityLoginLog.Id, securityLoginPoco.SecurityLoginsLogs.FirstOrDefault().Id);

            Assert.IsNotNull(securityLoginPoco.SecurityLoginsRoles);
            Assert.IsTrue(securityLoginPoco.SecurityLoginsRoles.Count > 0);
            Assert.AreEqual(this._securityLoginRole.Id, securityLoginPoco.SecurityLoginsRoles.FirstOrDefault().Id);
        }
        ...
        private void CompanyJobSkillForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._companyJob.Id, companyJobSkillPoco.CompanyJob.Id);
        }
        ...
        private void CompanyJobEducationForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._companyJob.Id, companyJobEducationPoco.CompanyJob.Id);
        }
        ...
        private void CompanyLocationForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._companyProfile.Id, companyLocationPoco.CompanyProfile.Id);

            Assert.IsNotNull(companyLocationPoco.SystemCountryCode);
            Assert.AreEqual(this._systemCountry.Code, companyLocationPoco.SystemCountryCode.Code);
        }
        ...
        private void CompanyJobDescriptionForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._companyJob.Id, companyJobDescPoco.CompanyJob.Id);
        }
        ...
        private void CompanyJobForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._companyProfile.Id, companyJobPoco.CompanyProfile.Id);

            Assert.IsNotNull(companyJobPoco.CompanyJobDescriptions);
            Assert.IsTrue(companyJobPoco.CompanyJobDescriptions.Count > 0);
            Assert.AreEqual(this._companyJobDescription.Id, companyJobPoco.CompanyJobDescriptions.FirstOrDefault().Id);

            Assert.IsNotNull(companyJobPoco.CompanyJobEducations);
            Assert.IsTrue(companyJobPoco.CompanyJobEducations.Count > 0);
            Assert.AreEqual(this._companyJobEducation.Id, companyJobPoco.CompanyJobEducations.FirstOrDefault().Id);

            Assert.IsNotNull(companyJobPoco.CompanyJobSkills);
            Assert.IsTrue(companyJobPoco.CompanyJobSkills.Count > 0);
            Assert.AreEqual(this._companyJobSkill.Id, companyJobPoco.CompanyJobSkills.FirstOrDefault().Id);
        }
        ...
        private void CompanyDescriptionForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._companyProfile.Id, companyDescriptionPoco.CompanyProfile.Id);

            Assert.IsNotNull(companyDescriptionPoco.SystemLanguageCode);
            Assert.AreEqual(this._systemLangCode.LanguageID, companyDescriptionPoco.SystemLanguageCode.LanguageID);
        }
        ...
        public void CompanyProfileForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._companyDescription.Id, companyProfilePoco.CompanyDescriptions.FirstOrDefault().Id);

            Assert.IsNotNull(companyProfilePoco.CompanyJobs);
            Assert.IsTrue(companyProfilePoco.CompanyJobs.Count > 0);
            Assert.AreEqual(this._companyJob.Id, companyProfilePoco.CompanyJobs.FirstOrDefault().Id);

            Assert.IsNotNull(companyProfilePoco.CompanyLocations);
            Assert.IsTrue(companyProfilePoco.CompanyLocations.Count > 0);
            Assert.AreEqual(this._companyLocation.Id, companyProfilePoco.CompanyLocations.FirstOrDefault().Id);
        }
        ...
        private void ApplicantWorkHistoryForeignKeyCheck()
        {
            ...
            Assert.AreEqual(this._applicantProfile.Id, applicantWorkHistoryPoco.ApplicantProfile.Id);

            Assert.IsNotNull(applicantWorkHistoryPoco.SystemCountryCode);
            Assert.AreEqual(this._systemCountry.Code, applicantWorkHistoryPoco.SystemCountryCode.Code);
        }
